(*@
  ...
  Date = "2014-01-03T09:29:06.2249127-04:00";
...
<img src="hokusai_sm.jpg" style="margin-bottom:10px;border:4px solid black" title="The Great Wave off Kanagawa" /><br />
<small style="font-size:90%">Click here to see the result live!</small>
</a>
</div>

For the last few years, the Japanese F# community has been running the F#
Advent Calendar
([2010](http://atnd.org/events/10685),
[2011](http://partake.in/events/1c24993a-c475-4fc2-bca4-7a1cd2f81869),
[2012](http://atnd.org/events/33927)
and also [this year](http://connpass.com/event/3935/)).
Each advent day, one person writes an article about something interesting in F#.
I have been following the advent calendar last year on Twitter and when
the planning started for this year, I offered to write an article too.
A number of people helped to make this happen - [@@igeta](https://twitter.com/igeta)
arranged everything and helped with reviewing, [@@yukitos](http://twitter.com/yukitos)
translated the article and [@@gab_km](http://twitter.com/gab_km) reviewed the translation.
Thanks!
