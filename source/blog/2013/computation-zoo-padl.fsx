(*@
  ...
  Date = "2013-11-08T01:42:56.7559875-05:00";
  Description = "A month or so back, I wrote a tweet saying that F# computation " +
    "expressions are amazing and no other language has anything like that. I can finally " +
    "provide all the evidence by linking to a PADL 2014 paper about them.";
*)
