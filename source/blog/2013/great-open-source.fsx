(*@
  ...
  Date = "2013-10-31T09:29:06.2249127-04:00";
  Description = "The hard part about open-source development is not putting the source code " +
    "on the internet. The hard part is keeping the source, releases and documentation " +
    "up-to-date. I'm still amazed how nicely FAKE solves this problem for F#.";
*)
