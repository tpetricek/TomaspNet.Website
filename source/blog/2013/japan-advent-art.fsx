(*@
  ...
  Date = "2013-12-24T04:58:37.5115170+01:00";
  Description = "この記事は毎年日本のF#コミュニティで主催されている" +
    "F# Advent Calendarへの寄稿です。それゆえに、日本文化に" +
    "インスパイアされたものになっています。ここではFreebaseにある日本の" +
    "画家一覧を参照して、フラクタルとFunScript（！）を組み合わせることで絵画の一部の" +
    "再生成を試みています。";
*)
(**
