(*@
  ...
  Date = "2015-04-01T12:41:49.5611652+02:00";
  Description = "The new release of the C# language migth seem as a minor " +
    "version, but in fact, it contains a hidden gem. In fact, it contains " +
    "awesome support for pattern matching - but for some reason, this is " +
    "concealed under the name 'exception filters'.";
