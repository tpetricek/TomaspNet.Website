(*@
  ...
  Date = "2015-01-15T17:58:17.9508797+01:00";
  Description = "There is a bunch of visualization and charting libraries for F#. Sadly, " +
    "perhaps the most advanced ones do not work particularly well outside of Windows. This " +
    "blog post introduces a new work-in-progress library called FnuPlot " +
    "which is a lightweight and cross-platform wrapper for gnuplot." ;
