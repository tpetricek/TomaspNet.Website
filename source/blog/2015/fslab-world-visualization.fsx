(*@
  ...
  Description = "This blog post combines two interesting FsLab libraries. It uses the " + 
    " World Bank type provider from F# Data to get a number of interesting indicators about " +
    "different countries of the world and it visualizes them using the XPlot library " +
    "which makes it easy to build rich HTML5 visualizations using Google Charts and Plotly.";
  HasLargeImage = true;
  Image = "http://tomasp.net/blog/2015/fslab-world-visualization/world-large.png";
*)
(*** hide ***)
#I "../packages/2015/"
