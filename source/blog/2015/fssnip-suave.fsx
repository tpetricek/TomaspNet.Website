(*@
  ...
  Description = "The core of many web sites and web APIs is very simple. Given an HTTP request, " +
    "produce a HTTP response. Sounds pretty simple, so why are there so many evil frameworks " +
    "that make simple web programming difficult? In this blog post, I'll write about Suave -" + 
    "a nice composable library for web programming with F#. The blog post also shows a few " +
    "interesting samples from the new version of F# Snippets and you are welcome to contribute!";
