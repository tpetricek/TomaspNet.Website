(*@
  ...
  Date = "2015-12-30T19:09:34.5852095+01:00";
  Description = "This year, my #FsAdvent contribution ended up on December 31." +
    "To celebrate the beginning of the New Year 2016, I built an interactive " +
    "web application that visualizes 'Happy New Year' tweets across the globe. " + 
    "It uses a range of interesting F# libraries including F# Data Toolbox for " +
    "calling Twitter, Suave.io web server and F# agents.";
