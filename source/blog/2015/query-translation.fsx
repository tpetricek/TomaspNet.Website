(*@
  ...
  Date = "2015-04-07T14:41:29.5465755+02:00";
  Description = "F# 3.0 provides full support for writing LINQ-style queries " +
    "and the syntax can be used with SQL databases and many other standard " +
    "data sources. But you can also write your own querying computation. " +
    "This blog post shows a minimal example that shows how to parse F# queries " +
    "and translate them to other querying language (like SQL).";
