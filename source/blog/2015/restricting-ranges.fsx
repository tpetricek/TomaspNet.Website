(*@
  ...
  Description = "I was recently working on some code for handling data ranges and " +
    "I wrote initial version in C#. Later, I realized that I needed an F# version, " +
    "so I went through the process of rewriting a simple function from C# to F#. This "+
    "blog post compares the two versions.";
