(*@
  ...
  Description = "The most recent version of Ionide comes with a completely revamped version of" +
    " F# Interactive which makes it possible to format the results of running F# code as HTML. " +
    "This blog post provides some of the details about how this works and it also introduces " +
    "an Ionide integration with FsLab, which gives you new powerful tools for doing data science with F#.";
